...
/* Class : KWA25_TC04_MaxValueValidationOnDenominationPage-Verify that app highlights the mix/max label for value exceeding the max range.
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2017
* 
*/
public class Sprint2_KWA25_TC04_MaxValueValidationOnDenominationPage extends GenericClass{
	
	public static boolean flag;
	public static String imagePath;
	
	@Test
	public void maxValueValidationOnDenominationPage(){
		...
		try{
			...
			int GeneratedMaxValue = Utility.generateRandomNumberGreaterThenMaxValue(MaxMinValue);
