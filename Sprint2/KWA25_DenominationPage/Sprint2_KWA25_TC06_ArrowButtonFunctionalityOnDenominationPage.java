...
/* Class : KWA25_TC06_ArrowButtonFunctionalityOnDenominationPage-Verify the functionality of the arrow button on num pad of range page.
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2017
* 
*/
public class Sprint2_KWA25_TC06_ArrowButtonFunctionalityOnDenominationPage extends GenericClass{
	
	public static boolean flag;
	public static String imagePath;
	
	@Test
	public void arrowButtonFunctionalityOnDenominationPage(){
		...
		try{
			...
			Utility.arrowButtonFunctionality();
