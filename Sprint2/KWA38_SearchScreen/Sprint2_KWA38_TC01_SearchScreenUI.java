...
* 
*/
public class Sprint2_KWA38_TC01_SearchScreenUI extends GenericClass{
	...
	public void searchScreenUI(){
		...
		try{
			...
			Thread.sleep(5000);
			Utility.getLocator("(//*[ @class='cardText'])[1]##xp").isDisplayed();
			Reports.pass("As Expected,Category Button is visible");
			Log.info("As Expected,Category Button is visible");
			
			
			Utility.getLocator("(//*[ @class='cardText'])[2]##xp").isDisplayed();
			Reports.pass("As Expected, StoreName button is visible");
			Log.info("As Expected, StoreName button is visible");
			
			
			Utility.getLocator("(//*[ @class='cardText'])[3]##xp").isDisplayed();
			Reports.pass("As Expected,Brand button is visible");
			Log.info("As Expected,Brand button is visible");
						
			
			Utility.getLocator(KioskLocatorsMapper.goBackButtonCC).isDisplayed();
			Reports.pass("As Expected,GO Back button is visible");
			Log.info("As Expected,Go Back button is visible");			
