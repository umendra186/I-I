...
/* Class : KWA39_TC05_SortingFunctionalaityForBrand- Verify sorting on Card of brand
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2017
* 
*/

public class Sprint2_KWA39_TC05_SortingFunctionalaityForBrand extends GenericClass {
	...
	@Test
	public void sortingFunctionalaityForBrand(){
		...
		try {
			...
			/*// Click on Brand Name
			Utility.touchEvent(Utility.getLocator(KioskLocatorsMapper.brand));
			Reports.info("User Successfully clicked on brand Button");
