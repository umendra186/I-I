...
/**
 * Class : KWA44_TC08_MobileWalletNavigation - Verify Mobile Wallet button navigation 
 * Author : Umendra Singh Tomar
 * (C) Xavient Information System 2017
 * 
 */

public class KWA44_TC08_MobileWalletNavigation extends GenericClass {
	...
	@Test
	public void mobileWalletNavigation () {
		...
		try {
			...
			// Click on Debit Card button and verify Navigation 			
			...
			assertTrue(Utility.urlVerification("card-send/mobile-wallet"));
