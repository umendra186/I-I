...
/* 
* Class : KWA44_TC03_GoBackFunctionalityOnTenderScreen
* Author : Umendra Singh Tomar
* (C) Xavient Information System 2017
* 
*/
public class Sprint2_KWA44_TC03_GoBackFunctionalityOnTenderScreen extends GenericClass {
	...
	public void goBackFunctionalityOnTenderScreen(){
		...
		try{
			...
			Utility.goBackButton(expectedtodaysTotal, Utility.getLocator(KioskLocatorsMapper.todaystotal),"card-send/cart");		
