...
/* Class : Sprint3_KWA134_TC04_RecipientEmailNavigation -- Validate Navigation on click on Invalid Recipient email
*  Author : Sayed Zeeshan Haidar
* (C) Xavient Information System 2017
*/

public class Sprint3_KWA134_TC04_RecipientEmailNavigation extends GenericClass {

	@Test
	public void RecipientEmailNavigation() {
		...
		try {
			...
			// Click on Recipient Email button
			Utility.touchEvent(Utility.getLocator(KioskLocatorsMapper.recipientEmail));
			Reports.pass("User successfully clicked on Invalid Email");
			Log.info("User successfully clicked on Invalid Email");
			assertTrue(Utility.urlVerification("card-send/card-personalization/address"));
			Reports.pass("User Successfully navigated on Ist page of Personalization Screen");
						
			//Verify Recipient Email text box is highlighted
			EmailFailureScreen.validateFocusField(Utility.getLocator(KioskLocatorsMapper.reciverEmail));
