...
/* Class : Sprint3_KWA49_TC07_NonAlphanumericValidationForRecipentName -- This test case is to verify validation when enter Invalid input for the field 'Recipient's Name'
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC07_NonAlphanumericValidationForRecipientName extends GenericClass{
	...
	@Test
	public void nonAlphanumericValidation(){
		...
		try{
			...
			Log.info("Excel Value--->"+ExcelUtils.readDataForPersonalization().get("RNameNonAlphanumeric"));
			...
			Thread.sleep(2000);
			/*if(Utility.getLocator(KioskLocatorsMapper.recipientName).getAttribute("ng-reflect-model").equals(ExcelUtils.readDataForPersonalization().get("RNameNonAlphanumeric"))){
				Reports.pass("User Able to enter the NonAlphanumeric in Recipient Name Field");*/
			...
			/*}else{
				imagePath = Utility.getfailScreenshot();
				Reports.attachfailScreenshot("", imagePath);
				Reports.fail("User is unable to enter the NonAlphanumeric in Recipient Name");
				}		*/
