...
/* Class : Sprint3_KWA49_TC11_GarbageDataValidationForRecipentEmail --Verify 'Recipient's Email' field when  enter garbage data 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC11_GarbageDataValidationForRecipientEmail extends GenericClass{
	...
	@Test
	public void garbageDataValidationForRecipentEmail(){
		...
		try{
			...
			Utility.getLocator(KioskLocatorsMapper.recipientEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailGarbageValue"));
