...
/* Class : Sprint3_KWA49_TC14_LeadingDotValidationForRecipientEmail --Verify 'Recipient's Email' field when  username is missing 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC14_LeadingDotValidationForRecipientEmail extends GenericClass{
		...
		@Test
		public void leadingDotValidationForRecipientEmail(){
			...
			try{
				...
				Utility.getLocator(KioskLocatorsMapper.recipientEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailLeadingDot"));
