...
/* Class : Sprint3_KWA49_TC17_ValidEmailValidationForRecipientEmail --Verify 'Recipient's Email' field when enter Text followed with email 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC17_FollowedbyTextValidationForRecipientEmail extends GenericClass{
		...
		@Test
		public void validEmailValidationForRecipientEmail(){
			...
			try{
				...
				Log.info("Excel Value--->"+ExcelUtils.readDataForPersonalization().get("REmailFollowedByText"));
				Utility.getLocator(KioskLocatorsMapper.recipientEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailFollowedByText"));
