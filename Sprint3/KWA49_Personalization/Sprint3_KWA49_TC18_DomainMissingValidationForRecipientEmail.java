...
/* Class : Sprint3_KWA49_TC18_DomainMissingValidationForRecipientEmail --Verify 'Recipient's Email' field when Missing top level domain (.com/.net/.org/etc.)
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC18_DomainMissingValidationForRecipientEmail extends GenericClass{
		...
		@Test
		public void domainMissingValidationForRecipientEmail(){
			...
			try{
				...
				Log.info("Excel Value--->"+ExcelUtils.readDataForPersonalization().get("REmailMissingDomain"));
				Utility.getLocator(KioskLocatorsMapper.recipientEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailMissingDomain"));
