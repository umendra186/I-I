...
/* Class : Sprint3_KWA49_TC19_LeadingDashInFrontOfDomainValidationForRecipientEmail --Verify 'Recipient's Email' field when enter Leading dash in front of domain
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC19_UnderScoreInFrontOfDomainValidationForRecipientEmail extends GenericClass{
		...
		@Test
		public void leadingDashInFrontOfDomainValidationForRecipientEmail(){
			...
			try{
				...
				Log.info("Excel Value--->"+ExcelUtils.readDataForPersonalization().get("REmailUnderScore"));
				Utility.getLocator(KioskLocatorsMapper.recipientEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailUnderScore"));
