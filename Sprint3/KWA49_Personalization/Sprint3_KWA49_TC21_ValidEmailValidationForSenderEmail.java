...
/* Class : Sprint3_KWA49_TC21_ValidEmailValidationForSenderEmail --Verify the valid input entry in 'Sender's Email' field 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC21_ValidEmailValidationForSenderEmail extends GenericClass{
		...
		public void validEmailValidationForSenderEmail(){
			...
			try{
				...
				Log.info("Excel Value--->"+ExcelUtils.readDataForPersonalization().get("SEmailValidEmail"));
				Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("SEmailValidEmail"));
