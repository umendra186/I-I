...
/* Class : Sprint3_KWA49_TC22_AtTheRateSignValidationForSenderEmail --This test case is to verify the validation on 'Sender's Email' field when user enter email which does not contain @Sign 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC22_AtTheRateSignValidationForSenderEmail extends GenericClass{
		...
		@Test
		public void atTheRateSignValidationForSenderEmail(){
			...
			try{
				...
				Log.info("Excel Value--->"+ExcelUtils.readDataForPersonalization().get("REmail@Missing"));
