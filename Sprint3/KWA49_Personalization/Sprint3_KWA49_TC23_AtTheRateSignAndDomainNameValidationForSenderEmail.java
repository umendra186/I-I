...
/* Class : Sprint3_KWA49_TC23_AtTheRateSignAndDomainNameValidationForSenderEmail --Verify 'Recipient's Email' field when @ sign and domain is missing
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC23_AtTheRateSignAndDomainNameValidationForSenderEmail extends GenericClass{
	...
	public void atTheRateSignAndDomainNameValidationForRecipentEmail(){
		...
		try{
			...
			Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmail@andDomainMissing"));
