...
/* Class : Sprint3_KWA49_TC25_SenderEmailValidationWhenUserNameMissingFromEmail --This test case is to verify the validation on 'Sender's Email' field when user enter email which does not contain username 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC25_SenderEmailValidationWhenUserNameMissingFromEmail extends GenericClass{
	...
	public void senderEmailValidationWhenRecipentNameMissing(){
		...
		try{
			...
			Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailWhenUserNameMissing"));
