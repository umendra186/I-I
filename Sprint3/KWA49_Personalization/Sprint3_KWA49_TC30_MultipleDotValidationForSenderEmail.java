...
/* Class : Sprint3_KWA49_TC30_MultipleDotValidationForSenderEmail --Verify 'Sender's Email' field when enter Multiple dots 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC30_MultipleDotValidationForSenderEmail extends GenericClass{
		...
		@Test
		public void multipleDotValidationForSenderEmail(){
			...
			try{
				...
				Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailMultipleDot"));
