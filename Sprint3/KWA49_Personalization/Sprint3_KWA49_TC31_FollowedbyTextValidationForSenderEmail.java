...
/* Class : Sprint3_KWA49_TC31_FollowedbyTextValidationForSenderEmail --Verify 'Sender Email' field when enter Text followed with email 
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC31_FollowedbyTextValidationForSenderEmail extends GenericClass{
		...
		@Test
		public void validEmailValidationForSenderEmail(){
			...
			try{
				...
				Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailFollowedByText"));
