...
/* Class : Sprint3_KWA49_TC32_DomainMissingValidationForSenderEmail --Verify 'Sender's Email' field when Missing top level domain (.com/.net/.org/etc.)
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC32_DomainMissingValidationForSenderEmail extends GenericClass{
		...
		@Test
		public void domainMissingValidationForSenderEmail(){
			...
			try{
				...
				Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailMissingDomain"));
