...
/* Class : Sprint3_KWA49_TC33_UnderScoreInFrontOfDomainValidationForSenderEmail --Verify 'Sender Email' field when enter Leading underscore in front of domain
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC33_UnderScoreInFrontOfDomainValidationForSenderEmail extends GenericClass{
		...
		@Test
		public void underScoreInFrontOfDomainValidationForSenderEmail(){
			...
			try{
				...
				Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailUnderScore"));
