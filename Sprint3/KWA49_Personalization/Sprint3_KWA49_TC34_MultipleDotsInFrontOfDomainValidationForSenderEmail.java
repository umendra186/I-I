...
/* Class : Sprint3_KWA49_TC34_MultipleDotsInFrontOfDomainValidationForSenderEmail --Verify 'Sender's Email' field when enter Multiple dot in the domain portion
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC34_MultipleDotsInFrontOfDomainValidationForSenderEmail extends GenericClass{
		...
		@Test
		public void mltipleDotsInFrontOfDomainValidationForSenderEmail(){
			...
			try{
				...
				Utility.getLocator(KioskLocatorsMapper.senderEmailInputBox).sendKeys(ExcelUtils.readDataForPersonalization().get("REmailMultipleDotInFrontDomain"));
