...
/* Class : Sprint3_KWA49_TC35_NextButtonValidationWhenRecipientNameInvalid --Verify Next button behavior when enter invalid data in 'Recipient's Name' field
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC35_NextButtonValidationWhenRecipientNameInvalid extends GenericClass{
		...
		public void nextButtonValidationWhenRecipientNameInvalid(){
			...
			try{
				...
				Thread.sleep(2000);				
			if (Utility.getLocator(KioskLocatorsMapper.recipientNameErrorMsg)
					.getText().equals("Please enter valid name")) {
				...
				if (Utility.currentURL().endsWith(
					...
					Reports.pass("User is still on same page after clicked on Next Button when Recipient Name is entered worng and Recipient/Sender Email are correct");
				} else {
