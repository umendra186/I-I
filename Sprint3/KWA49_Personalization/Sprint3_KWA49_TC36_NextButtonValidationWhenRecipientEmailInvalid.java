...
/* Class : Sprint3_KWA49_TC36_NextButtonValidationWhenRecipientEmailInvalid --Verify Next button behavior when enter invalid data in 'Recipient's Email' field
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC36_NextButtonValidationWhenRecipientEmailInvalid extends GenericClass{
		...
		@Test
		public void nextButtonValidationWhenRecipientNameInvalid(){
			...
			try{
				...
				Reports.info("User Successfully Entered the value in Recipient Email as --->"+ExcelUtils.readDataForPersonalization().get("REmail@andDomainMissing"));
