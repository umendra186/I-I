...
/* Class : Sprint3_KWA49_TC39_NextButtonValidationWhenRecipientNameFieldEmpty --Verify Next button behavior when 'Recipient's Name'  field is empty
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC39_NextButtonValidationWhenRecipientNameFieldEmpty extends GenericClass{
		...
		@Test
		public void nextButtonValidationWhenRecipientNameFieldEmpty(){
			...
			try{
				...
				Reports.info("User Successfully Entered the value in Sender's Email as --->"+ExcelUtils.readDataForPersonalization().get("REmailValidEmail"));
				...
				Thread.sleep(2000);				
				if (Utility.getLocator(KioskLocatorsMapper.recipientNameErrorMsg).getText().equals("Please enter valid name"))  {
				...
				if (Utility.currentURL().endsWith(
					...
					Reports.pass("User is still on same page after clicked on Next Button");
				} else {
