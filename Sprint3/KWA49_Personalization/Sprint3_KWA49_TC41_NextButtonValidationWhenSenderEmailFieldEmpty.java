...
/* Class : Sprint3_KWA49_TC41_NextButtonValidationWhenSenderEmailFieldEmpty --Verify Next button behavior when 'Recipient's Email'  field is empty
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC41_NextButtonValidationWhenSenderEmailFieldEmpty extends GenericClass{
		...
		@Test
		public void nextButtonValidationWhenSenderEmailFieldEmpty(){
			...
			try{
				...
				Thread.sleep(2000);				
				if (Utility.getLocator(KioskLocatorsMapper.senderEmailErrorMsg).getText().equals("Please enter valid email"))  {
