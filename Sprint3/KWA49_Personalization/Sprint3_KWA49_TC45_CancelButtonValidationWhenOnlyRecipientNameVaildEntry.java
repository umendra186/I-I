...
/* Class : Sprint3_KWA49_TC45_CancelButtonValidationWhenOnlyRecipientNameVaildEntry -- Verify the functionality of Cancel button when  fields have valid and invalid both info
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2018
* 
*/
public class Sprint3_KWA49_TC45_CancelButtonValidationWhenOnlyRecipientNameVaildEntry extends GenericClass{
		...
		@Test
		public void cancelButtonValidationWhenOnlyRecipientNameVaildEntry (){
			...
			try{
				...
				Reports.info("User Successfully Entered the value in Recipient Email as --->"+ExcelUtils.readDataForPersonalization().get("REmailLeadingDot"));
