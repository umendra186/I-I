...
/* Class : Sprint3_KWA49_TC02_AppLogoNavigationOfPersonalizationScreen -- Verify the functionality of I&I Logo on Personalization screen
*  * Author : Umendra Singh Tomar
* (C) Xavient Information System 2017
* 
*/
public class Sprint3_KWA49_TC47_NextOfPersonalizationScreen_AppLogoNavigation extends GenericClass {
	...
	@Test
	public void appLogoFunctionality(){
		...
		try{
			...
			//Entering the data on Personalization screen
			...
			Utility.touchEvent(Utility.getLocator(KioskLocatorsMapper.appLogo));
			Reports.pass("User Successfully clicked on logo");
			Log.info("User Successfully clicked on logo");
			if (Utility.currentURL().endsWith("/card-personalization/message")) {
				Reports.pass("As Expected, User is still on the same page");
				Log.info("As Expected, User is still on the same page");
			} else {
				Reports.fail("User is not on the same page");
				Log.info("User is not on the same page");
