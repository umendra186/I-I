...
public class Sprint1_KWA16_TC03_GoBackFunctionalityCreditCard extends GenericClass {
	...
	public void goBackFunctionalityCreditCard(){
		...
		try{
			...
			Utility.urlVerification("/card-payment");
			Reports.pass("User successfully redirected back to tender screen");
			Log.info("User successfully redirected back to tender screen");
